...
*   **Smart AI Rewriting:** Pass your transcribed text through a local LLM to fix grammar, translate languages, or change the tone before it's typed.
*   **Live Preview:** Real-time transcription feedback in the overlay as you speak. See exactly what the AI hears before it types.
...
*   **Other tools:** Advanced audio filtering, System Tray integration, Smart Language Detection, and Hallucination Filtering.
...
### For Users
1.  Download the latest release (`.exe` or `.zip`) from the [Releases](https://github.com/Effzumdeh/WhisperTyper/releases) page.
...
*   **Hardware Acceleration & Performance:**
    ...
    *   **CPU Mode:** If you experience instability, you can force CPU mode in Settings. Note that **Live Preview** requires significant resources and will show as "High CPU Usage" on a CPU-only setup.
